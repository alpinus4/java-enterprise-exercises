package com.example.lab3.observer;
...
public class InitializedData {
    ...
    private void init() {
        ...
        Brewery tyskie_browary_ksiazece = Brewery.builder().id(UUID.randomUUID()).establishmentDate(LocalDate.of(1629, 1, 1)).name("Tyskie Browary Ksiazece").location("Tychy").build();

        Beer tyskie_gronie = Beer.builder().id(UUID.randomUUID()).name("Tyskie Gronie").brewery(tyskie_browary_ksiazece).type(Beer.Type.LIGHT).brewingDate(LocalDate.of(2023, 7, 9)).alcoholContent(5.2F).build();
